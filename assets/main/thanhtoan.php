<?php
	...
	if($cart_query){
		...
		$tieude = "Đặt hàng website Bất động sản KT thành công!";
		...
		foreach($_SESSION['cart'] as $key => $val){
			...
			<ul style='border:1px solid blue;margin:10px;'>
				<li>Tên bất động sản : ".$val['tensanpham']."</li>
				<li>Mã sản phẩm : ".$val['masp']."</li>
				<li>Giá BĐS : ".number_format($val['giasp'],0,',','.')."đ</li>
				<li>Số Lượng mua : ".$val['soluong']."</li>
			</ul>";
		}
